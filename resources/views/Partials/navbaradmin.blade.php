    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mx-auto mt-3 mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="fw-bold nav-link {{ $title === 'Order' ? 'active' : '' }}" href="{{ route('admin.order') }}">Order</a>
                </li>
                <li class="nav-item">
                    <a class="fw-bold nav-link {{ $title === 'Payment' ? 'active' : '' }}" href="{{ route('admin.payment') }}">Payment</a>
                </li>
                <li class="nav-item">
